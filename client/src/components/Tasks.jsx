            ...
            <div className="space-y-4">
              {tasks.length === 0 ? (
                ...
                tasks.map((task) => (
                  <div
                    key={task._id}
                    className="bg-white/50 backdrop-blur-sm rounded-xl border border-gray-200 p-5 transition-all duration-200 hover:shadow-md hover:scale-[1.01]"
                  >
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex items-center gap-3">
                        <select
                          ...
                          className={`text-sm border rounded-lg px-3 py-2 bg-white/80 backdrop-blur-sm focus:outline-none focus:ring-2 focus:border-blue-500 transition-all duration-200 font-medium ${
                            task.status === 'Todo'
